...
export function CashierLogin({ onLogin, onBack }: CashierLoginProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    onLogin(credentials.username || 'Cajero');
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl mb-2 text-white">Punto de Venta</h1>
          <p className="text-slate-400">MOVIELAND - Sistema de Taquilla</p>
        </div>

        <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 border border-slate-700">
          <h2 className="text-2xl mb-6 text-white text-center">Acceso Cajero</h2>
